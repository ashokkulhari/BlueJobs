 ...
 */
@Configuration
public class WebMvcConfig implements ServletContextInitializer, WebServerFactoryCustomizer<WebServerFactory> {
    ...
    public WebMvcConfig(Environment env, JHipsterProperties jHipsterProperties) {
